...
class RealDebridDownloadService(
    ...
    suspend fun saveDownload(realDebridDownload: RealDebridDownload): RealDebridDownloadEntity {
        return updateDownloadValues(
            realDebridDownloadRepository.getByDownloadId(realDebridDownload.id) ?: RealDebridDownloadEntity(),
            realDebridDownload
    ...
    suspend fun getDownloadLink(linkId: String): RealDebridDownloadEntity? =
        realDebridDownloadRepository.getByDownloadId(linkId)
